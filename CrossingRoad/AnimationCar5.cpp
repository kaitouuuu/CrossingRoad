...
void AnimationCar5::setCollision()
{
...
void AnimationCar5::changeState()
{
	gameEnd = true;
}
...
void AnimationCar5::update(float speed, bool isappearesc)
{
...
float AnimationCar5::getX() const
{
	return x;
}

float AnimationCar5::getY() const
{
	return y;
}